...
class Shipment(models.Model):
    ...
    source = models.PositiveSmallIntegerField(choices=SOURCE_CHOICES, default=SOURCE_OWN, help_text="Whether the AWB number was generated by this system (Own) or entered manually from a third party")
